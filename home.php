            ...
            <div class="navbar__group">
                <div class="navbar__top--main">
                    <div class="menu--lang__main">
                        <svg class="q-icon"><use xlink:href="#icon-globe"></use></svg>
                        <ul class="menu--lang__main-list">
                    ...
                    <div class="header-search">
                        <a href="#" class="header-search__toggle js-header-search-toggle"><svg class="q-icon"><use xlink:href="#icon-search"></use></svg></a>
                        <div class="header-search__box js-header-search-box">
                            <form>
...
<div class="front-banner block-section front-banner--main">
    <div class="front-banner__bg" data-top-bottom="transform: translate3d(0px, 30%, 0px);"
         data-top="transform: translate3d(0px, 0%, 0px);" style="background-image: url('dist/images/backgrounds/bg-front-banner-2.jpg')"></div>
...
<div id="StockTickerContainer" class="stock-ticker-container">
    <div id='dvStockTicker' class="stockTicker stock-ticker"></div>
</div>
...
<div class="info-block block-section info-block__white">
    <div class="info-block__row">
        ...
        <div class="info-block__col is-image is-image--contain">
            <div class="info-block__image" style="background-image: url('dist/images/backgrounds/bg-laptop-1.png')"></div>
        </div>
    </div>
</div>
<div class="info-block info-block__white block-section">
    <div class="info-block__row">
        <div class="info-block__col is-image is-right">
...
<div class="info-block block-section">
    <div class="info-block__row">
        <div class="info-block__col">
            <div class="info-block__image is-image" style="background-image: url('dist/images/backgrounds/bg-image-exclusive.jpg')"></div>
        </div>
        <div class="info-block__col">
            <div class="info-block__content">
                <div class="info-block__icon"><svg class="q-icon"><use xlink:href="#simple-logo"></use></svg></div>
                ...
                <div class="info-block__list">
                    <p><b>Regulated by Kuwait Capital Markets Authority</b><br>We are licensed and regulated by the KMCA.</p>
                    <p><b>Member of Boursa Kuwai</b><br>Q8 Broker meets the strict capital requirements of the Kuwait Stock Exchange</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="info-block__row">
        <div class="info-block__col">
            <div class="info-block__content">
                ...
                <div class="info-block__list">
                    <p><b>Bank-level security</b><br>Your funds and assets are kept safe by the same security measures that banks deploy</p>
                    <p><b>Committed to privacy</b><br>We carefully protect our customers’ personal information.</p>
                </div>
            </div>
        </div>
        <div class="info-block__col">
...
<script src="src/scripts/plugins/jquery-yahoo-finance-api.js"></script>
</body>
