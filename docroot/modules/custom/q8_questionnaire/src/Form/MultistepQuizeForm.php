...
namespace Drupal\q8_questionnaire\Form;
...
use Drupal\q8_questionnaire\Manager\StepManager;
use Drupal\q8_questionnaire\Step\StepIntermediateResult;

/**
 * Provides multi step ajax Quiz form.
 *
 * @package Drupal\q8_questionnaire\Form
 */
class MultistepQuizeForm extends FormBase {
   ...
   *
   * @var \Drupal\q8_questionnaire\Manager\StepManager
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $node_id = NULL) {
    ...
    foreach ($buttons as $button) {
      /** @var \Drupal\q8_questionnaire\Button\ButtonInterface $button */
