...
namespace Drupal\q8_questionnaire\Manager;

use Drupal\q8_questionnaire\Step\StepInterface;
use Drupal\q8_questionnaire\Button\StepNextButton;
use Drupal\q8_questionnaire\Button\StepPreviousButton;
use Drupal\q8_questionnaire\Button\StepFinishButton;

/**
 * Class StepManager.
 *
 * @package Drupal\q8_questionnaire\Manager
 */
class StepManager {
   ...
   *
   * @var \Drupal\q8_questionnaire\Step\StepInterface
   */
  protected $steps;
   ...
   *
   * @param \Drupal\q8_questionnaire\Step\StepInterface $step
   *   Step of the form.
   * @param int $step_id
   *   Step ID.
   */
  ...
  public function map($step_class_name) {
    $map = [
      'StepTesting' => 'Drupal\\q8_questionnaire\\Step\\StepTesting',
      'StepIntermediateResult' => 'Drupal\\q8_questionnaire\\Step\\StepIntermediateResult',
      'StepResult' => 'Drupal\\q8_questionnaire\\Step\\StepResult',
      'StepQuestion' => 'Drupal\\q8_questionnaire\\Step\\StepQuestion',
    ];
