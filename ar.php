  ...
  <div class="front-banner__inner">
    <div class="page-frame">
      <div class="front-banner__title">
        <h1>
          مخططات بيانية وأدوات متقدمة لتحليل الاستراتيجيات وتنفيذها.
        </h1>
      </div>
    ...
    <div class="info-block__col">
      <div class="info-block__content">
        ...
        <ul class="info-block__list">
          ...
          <li><svg class="q-icon"><use xlink:href="#icon-checkmark"></use></svg>  مخططات بيانية وأدوات متقدمة لتحليل الاستراتيجيات وتنفيذها.</li>
        </ul>
